...
function App() {
    return (
        <div>
                ...
                {/*7.1*/}
                <Komentarz id={10}
                           body={'Film zaskakuje wciągającą fabułą i znakomitą grą aktorską, która trzyma w napięciu od początku do końca. Mimo kilku przewidywalnych momentów, całość pozostawia pozytywne wrażenie dzięki świetnemu obrazowi i emocjonalnej głębi.'}
